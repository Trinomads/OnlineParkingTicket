...
import com.onlineparkingticket.activity.SearchDetailActivity;
...
public class HomeSearchAdapter extends RecyclerView.Adapter {
    ...
    public HomeSearchAdapter(Context mContext, ArrayList<String> commentList, RecyclerView rvTrending, boolean paidTag) {
